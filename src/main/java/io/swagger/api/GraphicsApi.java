...
public interface GraphicsApi {
    ...
    @ApiOperation(value = "Añadir nueva gráfica", nickname = "addGraphic", notes = "Añadir nueva gráfica", response = Long.class, tags={ "graphics", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Operación válida", response = Long.class),
    ...
    ResponseEntity<List<Graphic>> findGraphicByMagnitude(@NotNull @ApiParam(value = "Magnitud de las medidas", required = true) @Valid @RequestParam(value = "magnitude", required = true) Long magnitude);
    ...
    @RequestMapping(value = "/graphics/generate",
        produces = { "application/xml", "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Graphic> generate(@NotNull @ApiParam(value = "Magnitud de las medidas", required = true) @Valid @RequestParam(value = "magnitude", required = true) Long magnitude,@NotNull @ApiParam(value = "Fecha de inicio del rango temporal de las medidas", required = true) @Valid @RequestParam(value = "startDate", required = true) OffsetDateTime startDate,@NotNull @ApiParam(value = "Fecha de fin del rango temporal de las medidas", required = true) @Valid @RequestParam(value = "endDate", required = true) OffsetDateTime endDate);
